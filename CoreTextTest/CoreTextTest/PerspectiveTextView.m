...
@implementation PerspectiveTextView
/*
其实这个和我们之前的mask的性质差不多，唯一多的是，可能加了一个背景，因为把layer draw 进context的时候，
需要注意的就是为什么这个textColor不管设置什么颜色，画上去的都是直接透视呢？
*/
