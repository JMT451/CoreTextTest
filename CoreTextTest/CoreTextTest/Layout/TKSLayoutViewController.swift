...
class TKSLayoutViewController: UIViewController, NSLayoutManagerDelegate{
    ...
    fileprivate lazy var textStorage:TKSLinkDetectingTextStorage = {
        ...
        do{
            ...
            let titleRange = NSString(string: text).range(of: "Nunc in mattis mi")
    ...
    override func viewDidLoad() {
        ...
        self.view.addConstraints(
            [
            NSLayoutConstraint(item: self.textView, attribute: NSLayoutAttribute.top, relatedBy: NSLayoutRelation.equal, toItem: self.view, attribute: NSLayoutAttribute.top, multiplier: 1, constant: 64),
